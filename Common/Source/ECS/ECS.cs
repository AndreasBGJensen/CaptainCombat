...
namespace CaptainCombat.Common {
    ...
    public class Domain {
        ...
        public Domain(uint localPlayerId = 0)
        {
        ...
        public void update(IEnumerable<ITuple> gameData) {
            ...
            foreach (var component in gameData) {
                ...
                // Skip local componentns
                if (clientId == LocalPlayerId) continue;
            ...
            foreach(var pair in registeredComponents) {
                ...
                if (id.clientId == LocalPlayerId) continue;
        ...
        public class Entity {
            ...
            public bool IsLocal { get => Id.clientId == Domain.LocalPlayerId; }
            ...
            public Entity(Domain domain) {
                ...
                Id = domain.registerEntity(this, domain.LocalPlayerId);
            }
        ...
        public abstract class Component {
            ...
            /// </summary>
            [JsonIgnore]
            public bool IsLocal { get => ClientId == Domain.LocalPlayerId; }
